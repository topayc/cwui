...
p12.certFromP12Asn1 = function(obj) {
	strict = true;
	...
	var pfx = {
  	...
  	_decodeAuthenticatedSafe(pfx, data.value, strict, undefined);
  	return pfx;
}
...
define(['./asn1','./hmac','./oids','./pkcs7asn1','./pbe','./random','./rsa','./sha1','./util','./x509'], function() {
