...
//config
var transkey_url='/SW/vender/Transkey';
...
function initTranskey(callback){
	setMaxDigits(131);
	if(tk==null){
...
Transkey.prototype.enterCallback = function(callback){
	enter = callback;
}
Transkey.prototype.buttonListener2 = function(e){
	...
	transkey[id].inputObj = document.getElementById(id);
