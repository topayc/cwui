...
<tr>
	...
	<!------------------------------------------------------------------->
		<div id=test_bed>
			...
			<table border="0" width="800px">
				<tr><td align="right">
					<span id="menu_situation">PC Demo > INISAFE CrossWeb SFilter > 공인인증센터 > 신규발급</span>
				</td></tr>
			</table>
			...
			<form id="readForm" name="readForm" action="./issue_result.jsp" method="post" accept-charset="EUC-KR">
				<input type="hidden" name="reqcode" value="20"/>
				
				<h1>공인인증서 신규발급 테스트 예제</h1>
					...
					<tr>
						...
						<!-- 입력 시작  -->
				            ...
				            <tr>
				            	...
				            	<td>
				            		<input type="text" id="REGNO" name="REGNO" value="<%=getNumber()%>" style="width:95%"/>
				            	</td>
				            	<td> "-" 없이 숫자만 기입하십시오.</td>
				            </tr>
				            <tr>
				            	...
				            	<td>
				            		<input type="text" id="USERID" name="USERID" value="T<%= USER_ID %>" style="width:95%"/>
				            	</td>
				            	<td></td>
				            </tr>
				            <tr>
				            	...
				            	<td>
				            		<input type="text" id="DETAILNAME" name="DETAILNAME" value="홍길동(INI)" style="width:95%"/>
				            	</td>
	...
	-->
					...
					<tr>
						<td align="right">
							<button onClick="javascript:SendForm();" class="button blue medium">신규  발급 정보 입력</button>
						</td>
					</tr>
					</table>
				</div>
