...
<!-- 2-1.OCSPCD SDK for Java 데몬 연결을 위한 SDK -->
		...
		<section class="ini-demo-contents-wrapper" id="content">
			...
			//System.out.println("      pkcs#7    ");
				...
				try {
					...
					// 서명에 사용된 원본데이터
				  orgData = URLDecoder.decode(signer.getData());
				...
				try{ 
					...
					if((juminNO != null) && (juminNO.trim().length()>0)){
				        ...
				        if(rnd != null) {
							...
							System.out.println("sign vid :"+strR);
				...
				*/
				...
				%>
					...
					<div class="dl-table bg">
						...
						<dl>
							<dt class="col-sm-2 col-xs-4">서명에 사용된 원본데이터</dt>
