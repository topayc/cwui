		...
		<section class="ini-demo-contents-wrapper" id="content">
			...
			<div class="ini-demo-contents">
				...
				<div class="ini-demo-transfer">
					<h2 class="ini-demo-title">전자서명(INIPlugin)</h2>
<%
		...
		if (m_IP.isClientAuth()) {
			...
			String chkvid = m_IP.getParameter("vid");
			...
			if(result){
				if(chkvid!=null && chkvid.equals("1")){
					//본인확인 검증 
					try{
			...
			m_IniErrMsg ="인증서가 제출되지 않았습니다.";
				...
				<div class="ini-demo-btns">
					<button type="button" class="btn btn-info btn-lg" onclick="javascript:goPage('203'); return false;">계속 이체</button>					
				</div>
			</div>
			<!-- contents end -->
		</section>
