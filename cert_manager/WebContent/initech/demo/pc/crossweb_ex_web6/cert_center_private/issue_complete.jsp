			...
			<div class="ini-demo-contents">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						<span class="icon check"><img src="../../../common/images/ico_check.png" alt=""></span>
						<p><b>공인인증서 신규발급 처리가 완료되었습니다.</b></p>
						</div>
					</div>
				</div>
				<div class="ini-demo-btns">
					<button type="button" class="btn btn-info btn-lg" onclick="javascript:goPage('401'); return false;">공인인증서 신규발급/재발급</button>
