	...
	<main class="ini-demo-container"> 
		...
		<section class="ini-demo-contents-wrapper" id="content">
			...
			<div class="ini-demo-contents">
				...
				<h2 class="ini-demo-title">사설 인증서 신규발급</h2>
				<div>
					<fieldset class="ini-demo-form">
						<legend>신규 발급 입력</legend>
						<form id="readForm" name="readForm" action="./issue_complete.jsp" method="post">
							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										<td>사용자ID</td>
										<td>
											<input type="text" title="" class="form-control" id="user_id" name="user_id" value="<%=getNumber()%>" />
										</td>
									</tr>
									<tr>
										<td>이름(CN)</td>
				...
				<div class="ini-demo-btns">
					<button type="button" class="btn btn-info btn-lg" onClick="PrivateCertProcessIssue(false)">신규발급</button>
				</div>
			</div>
			<!-- contents end -->
		</section>
