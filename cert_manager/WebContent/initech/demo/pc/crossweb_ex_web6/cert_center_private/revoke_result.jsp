...
function CertProcessRevoke(caName, serial, isHtml5) {
	...
	INIWEBEX.revokeCertificate({
		...
		serial : serial,
		isHtml5 : isHtml5,
		processCallback : "CertProcessResult"
	});
}
...
<%-- 				<%if(issueResult){%> --%>
				<div class="ini-demo-btns">
					<button type="button" class="btn btn-info btn-lg" onclick="CertProcessRevoke('<%=caName%>','<%=HexCertSerial%>', true); return false;">Html5 폐기된 인증서 삭제</button>
