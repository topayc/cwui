...
<script type="text/javascript">
	...
	function PrivateCertProcessIssue(isHtml5) {
		//INITECHCA_IssueCertificate(undefined, undefined, "IssueCertificateCallback", isHtml5);
		INIWEBEX.issueCertificate_INITECH({
			isHtml5 : isHtml5,
		...
		<section class="ini-demo-contents-wrapper" id="content">
			...
			<div class="ini-demo-contents">
				...
				<div class="ini-demo-btns">
					<button type="button" class="btn btn-info btn-lg" onClick="PrivateCertProcessIssue(true)" >Html5 사설인증서 신규발급</button>
